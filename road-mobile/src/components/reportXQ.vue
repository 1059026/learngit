<template>
  <div class="reportXQ">
    <div class="sub_main">
      ...
      <a href="javascript:;"  class="returnNow">下载报告</a>
    </div>
  </div>
</template>
...
<style scoped>
  .top_bar{height:90px; line-height:90px; padding:0 20px; text-align:center; background:#fc8113;}
  ...
  .Hrow h2{float:left; font-size:30px; color:#000; background:url(../../static/images/blue_list_style.png) no-repeat left center; padding-left:40px; font-weight:normal;}
  ...
  .tit h3{font-weight:normal; float:left;padding-left:40px; background:url(../../static/images/editIcon.png) no-repeat left center;}
  ...
  .rowList li span{font-size:24px; color:#666;}
  .rowList li i{float:right; font-size:24px; color:#000; font-style:normal;}
  .returnNow{background:#146bee; color:#fff; height:80px; line-height:80px; width:720px;  position:fixed; bottom:10px; left:50%; margin-left:-360px; border-radius:5px; text-align:center;}
</style>
